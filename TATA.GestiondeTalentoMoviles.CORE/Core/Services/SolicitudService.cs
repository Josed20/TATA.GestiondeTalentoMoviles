...
namespace TATA.GestiondeTalentoMoviles.CORE.Services
{
    public class SolicitudService : ISolicitudService
    {
        ...
        public async Task<SolicitudReadDto> CreateAsync(SolicitudCreateDto dto, string creadoPorUsuarioId)
        {
            ...
            // NOTA: No validamos que el usuario creador exista porque:
            // 1. En testing podemos usar IDs de prueba
            // 2. En producción este ID vendrá del JWT del usuario autenticado
            // 3. La validación real se hará a nivel de autenticación, no aquí
        ...
        )
        {
            ...
            // NOTA: No validamos que el usuario revisor exista porque:
            // 1. En testing podemos usar IDs de prueba
            // 2. En producción este ID vendrá del JWT del usuario autenticado
            // 3. La validación real se hará a nivel de autenticación, no aquí
